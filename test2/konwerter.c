...
int main()
{
  ...
  printf("Napis Latin2:  \"%s\"\n",Napis);  //zarowno w c jak i w cpp znaki zastepowane sa przez symbole z tablicy kodow

  KonwertujNapis(Napis,TabKodow,TabZnakow,IloscKodow);

  printf("Napis ASCII:   \"%s\"\n",Napis);  // cpp zastepuje znaki znakami z tablicy kodow a c z tablicy znakow 
